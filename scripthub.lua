...
Rayfield:Notify({
   ...
   Content = "creator: nowhudhejeir (goose_jr), it update",
   Duration = 6.5,
   Image = 4483362458,
})
...
local Label = Tab:CreateLabel("CREATOR:nowhudhejeir (display nickname goose_jr) fact:its version 2.0", 4483362458, Color3.fromRGB(0, 0, 0), false) -- Title, Icon, Color, IgnoreTheme


local Tab = Window:CreateTab("close hub/закрыть хаб", 4483362458) -- Title, Image


local Button = Tab:CreateButton({
    Name = "close its script/закрыть скрипт",
    Callback = function()
   Rayfield:Destroy()
    end,    
})
...
local Tab = Window:CreateTab("FE/Universal", 4483362458) -- Title, Image
...
local Button = Tab:CreateButton({
    Name = "hitbox (head)",
    Callback = function()
   loadstring(game:HttpGet('https://raw.githubusercontent.com/Minecraftfornikka/Hitbox.lua/refs/heads/main/Hitbox.lua'))()
    end,
})
...
local Button = Tab:CreateButton({
    Name = "solara hub (не реклама/this is not an advertisement)",
    Callback = function()
...
local Tab = Window:CreateTab("Kohls Admin House", 4483362458) -- Title, Image
...
local Tab = Window:CreateTab("skywars [classic] or 16bit skywars", 4483362458) -- Title, Image
...
local Tab = Window:CreateTab("muscle legends", 4483362458) -- Title, Image
