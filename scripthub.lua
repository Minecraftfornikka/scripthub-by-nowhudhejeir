local ArrayField = loadstring(game:HttpGet('https://raw.githubusercontent.com/UI-Interface/ArrayField/5e31d32dbaf862deadaf46cf2248729e52dbfa68/Source.lua'))()
...
ArrayField:Notify({
   Title = "hi, its script create nowhudhejeir. enjoy!",
   Content = "idk",
   Duration = 6.5,
   Image = 4483362458,
